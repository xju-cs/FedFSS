...
save_root = 'exp-r100/fedanchor_lamma_gamma_1'
## record time
...
args.exp_name='{}_anchor_{}lama{}_mu{}_lamma{}_gamma{}_embed{}'.format(args.exp_name,args.train_method,args.lama,args.mu,args.reweight_method,args.gamma,args.embed_dim)
...
def local_anchor_train(model, client_index, mu, temperature, epoch, loader, label_mapping, label_anchor):
    ...
    for batch in progress:
        ...
        nloss = loss.mean()
        # 计算辅助损失
        # 传入标签，label_mapping是id—label的映射，label_anchor是id-anchor的映射
...
def main(args):
    ...
    while epoch <= args.max_epoch:
        ...
        if epoch % args.round == 0:
            ...
            server_model.update_parameters_gamma(client_models, lambda_weights,gamma=args.gamma, mode=args.fed_mode)

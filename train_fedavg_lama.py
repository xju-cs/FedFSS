...
save_root = 'exp-r100/fedavg_lama_cmu'
...
args.exp_name='{}_{}_embed{}'.format(args.exp_name,args.reweight_method,args.embed_dim)
    ...
    while epoch <= args.max_epoch:
       ...
       # Update server with client model
        if epoch % args.round == 0:
            ...
            server_model.update_parameters(client_models, lambda_weights, mode=args.fed_mode)

...
save_root = 'exp-r100/fedanchor_lamma'
## record time
...
args.exp_name='{}_anchor_{}lama{}_mu{}_lamma{}_embed{}_batch{}'.format(args.exp_name,args.train_method,args.lama,args.mu,args.reweight_method,args.embed_dim,args.batch_size)
